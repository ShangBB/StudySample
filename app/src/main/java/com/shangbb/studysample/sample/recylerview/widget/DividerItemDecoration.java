...
/**
 * RecyclerView的ItemDecoration的默认实现 1. 默认使用系统的分割线 2. 支持自定义Drawable类型 3. 支持水平和垂直方向 4. 修复了官方垂直Divider显示的bug 扩展自官方android
 * sdk下的Support7Demos下的DividerItemDecoration
 */
