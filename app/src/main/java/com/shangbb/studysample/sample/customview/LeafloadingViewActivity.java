...
import com.shangbb.studysample.utils.AnimationUtils;

import java.util.Random;


public class LeafloadingViewActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leafloading_view);
