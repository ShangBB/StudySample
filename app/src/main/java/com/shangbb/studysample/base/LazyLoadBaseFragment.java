...
public abstract class LazyLoadBaseFragment extends Fragment {
    ...
    private void dispatchUserVisibleHint(boolean visible) {
        ...
        LogUtils.d(getClass().getSimpleName() + "  dispatchUserVisibleHint isParentInvisible() " + isParentInvisible());
    ...
    public void onFragmentFirstVisible() {
        LogUtils.d(getClass().getSimpleName() + "  onFragmentFirstVisible");

    }

    public void onFragmentResume() {
        LogUtils.d(getClass().getSimpleName() + "  onFragmentResume");
    }

    public void onFragmentPause() {
        LogUtils.d(getClass().getSimpleName() + "  onFragmentPause");
    }
