...
/**
 * @Fuction: 下拉页面放大指定View
 * @Author: BBShang
 * @Date: 2017/4/10 15:49
 */

public class PullDownEnlargeViewAnim {
    ...
    /**
     * @param parentView
     *         滚动布局，其实就是提供滑动监听的依赖布局，其实并不一定是父布局
     * @param childView
     *         需要放大的View，理论上可以是任何View，可以在任何布局里面
     */
    public PullDownEnlargeViewAnim(View parentView, View childView) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        int distance = (int) ((event.getY() - mFirstPosition) * 0.3); //
                        // 这边添加了一个对应滚动的系数，可以自由调节
                        if (distance < 0) {
                            break;
                        }
                        // 处理放大
    ...
    public void replayAnim() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                childView.setLayoutParams(lp);
                childView.scrollTo((int) ((int) (nowDistance * (1 - cVal) / 2) * MAGNIFICATION_X)
                        , 0);
            }
        });
        valueAnimator.start();
